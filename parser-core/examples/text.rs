...
use parser as abstract_parser;
use parser::{
    macros::choice_rule, rules::*, InputStreamIter, InputStreamTrait, Parser, ProductionError,
};
use parser_macros::token_rule;
...
#[token_rule(
    InputStream: InputStreamTrait<'a, TextInput>
    Output: Self
...
#[choice_rule(
    InputStream: InputStreamTrait<'src, TextInput>
    OutputGenerics: <'src, IS: InputStreamTrait<'src, TextInput>>
)]
#[derive(Debug, Clone)]
enum Vars<'src> {
