...
mod grammar_ {
    ...
    #[sequence_struct(
        TranferRule: abstract_parser::TransferRule<IS>
        InputStream: InputStreamTrait
    ...
    #[sequence_struct(
        TranferRule: abstract_parser::TransferRule<__IS>
        InputStream: InputStreamTrait
    )]
    ...
    macro_rules! field_token {
        ($i:ident) => {
            ...
            pub type ${concat($i, FieldName)} = IdentRule<$i>;
