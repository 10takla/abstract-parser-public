...
fn grammar() {
    ...
    check::<Grammar>(
        ...
        Ok(vec![RuleOutput {
            head: "A",
            expr: ExprOutput::Token(TokenOutput::RegExpr("[A-Z]")),
        }]),
    );
...
// #[sequence_struct(
//     OutputGenerics: <'src, __IS>
// )]
// pub struct SafeSeqItem<'src> {
//      #[abstract_parser(ignore)]
//     a: NegativeLookaheadRule<SequenceRule<(Space<'src>, DefineHead<'src, Ident<'src>>)>>,
//     b: IS<'src>,
// }
// }
